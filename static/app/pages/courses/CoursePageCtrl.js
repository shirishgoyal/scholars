(function () {
    ...
    function CoursePageCtrl($scope, $state, $stateParams, $log, $sce, lodash, Auth, Course, Slide) {
        ...
        vm.states = [
            {name: 'Reading', duration: 5, isComplete: false, isCurrent: true, state: 'talk.reading'},
            ...
            {name: 'Pending Approval', duration: 1, isComplete: false, state: 'talk.pending_approval'}
        ];
        ...
        Course.get($stateParams.id)
            .then(function (response, status) {
                ...
                vm.course.pdf_url = 'http://docs.google.com/gview?url=' + vm.course.pdf + '&embedded=true';
