(function () {
    ...
    function PageCtrl($scope, $state, $log, lodash, toastr, Auth, Course) {
        ...
        //         "category": "Web and Information Retrieval",
        //         "video_links": [
        //             {
        ...
        Course
            ...
            .then(function (response, status) {
                ...
                vm.paper_categories = lodash.groupBy(papers, 'category_display');
        ...
        Course
            .listFeatured()
            .then(function (response, status) {
                vm.featured_papers = lodash.map(response.data, function (paper) {
                    paper.image = 'https://i.ytimg.com/vi/' + paper.yid + '/maxresdefault.jpg';
                    return paper;
                });
